...
This is a simple script to download all [VGW](http://www.vgwak.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
...
"1700945","Göringen",10.189569,50.995499,""
```
